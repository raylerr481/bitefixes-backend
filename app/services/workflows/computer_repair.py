...
Handles computer and notebook repair requests.
...
def execute(
    ...
    """
    Execute computer repair workflow.
    """
    ...
    try:
        ...
        print(
            "[COMPUTER REPAIR WORKFLOW ERROR]",
            exc
        )
