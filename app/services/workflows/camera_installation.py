"""
Camera Installation Workflow

Handles security camera requests.
...
def execute(
    ...
    """
    Execute camera installation workflow.
    """
    ...
    try:
        ...
        print(
            "[CAMERA INSTALLATION WORKFLOW ERROR]",
            exc
        )
