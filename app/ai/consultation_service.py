...
def _contextual_inputs(context: Dict[str, Any]) -> tuple[list[dict[str, Any]], str | None, str | None, str | None]:
    ...
    entity = (state.get("active_object") or state.get("active_topic") or conversation.get("active_object") or conversation.get("active_topic") or memory.get("active_object") or memory.get("active_topic") or profile.get("company_name"))
