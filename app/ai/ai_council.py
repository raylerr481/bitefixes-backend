"""Bounded external-AI council for Bitey.
...
def _business_index(context: Dict[str, Any]) -> Dict[str, Any]:
    """Build a compact business-environment index for the external rector."""
...
async def _ask_provider(spec: Any, message: str, language: str, context: Dict[str, Any]) -> Dict[str, Any] | None:
    try:
        ...
        enriched_context = {**context, "business_context_index": business_index, "contextual_state": state, "contextual_directive": directive, **tool_context, "language": language, "rector_directives": RECTOR_DIRECTIVES}
