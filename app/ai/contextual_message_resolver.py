...
def resolve_contextual_message(
    ...
    *,
    ...
    if short and subject:
        ...
        return {"resolved_message": resolved, "needs_clarification": False,
                "research_candidate": _followup_needs_research(raw, active_url),
                "active_entity": subject, "active_goal": goal or None, "active_url": active_url}

    if _looks_like_public_entity(raw):
        return {"resolved_message": raw, "needs_clarification": False,
                "research_candidate": True, "active_entity": raw,
                "active_goal": goal or None, "active_url": active_url}

    if short and recent_text:
        return {"resolved_message": f"{recent_text[-500:]} | Seguimiento: {raw}",
                "needs_clarification": False,
                "research_candidate": _followup_needs_research(raw, active_url),
                "active_entity": subject or None, "active_goal": goal or None,
                "active_url": active_url}

    return {"resolved_message": raw, "needs_clarification": False,
            "research_candidate": False, "active_entity": subject or None,
            "active_goal": goal or None, "active_url": active_url}
